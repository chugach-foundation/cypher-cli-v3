...
impl Identifier for SpotHedger {
    fn symbol(&self) -> &str {
        self.symbol.as_str()
    }
}
...
#[async_trait]
impl OrderManager for SpotHedger {
    ...
    SpotHedger: Identifier,
{
    ...
    async fn pulse(&self, _ctx: &Self::Input) -> Result<HedgerPulseResult, HedgerError> {
